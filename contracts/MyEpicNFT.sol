...
contract MyEpicNFT is ERC721URIStorage {
  ...
  string[] firstWords = ["apple", "banana", "cherry", "date", "fig", "grape", 
    "honeydew", "imbe", "jackfruit", "kiwano", "lime", "mulberry",
    "nectarine", "olive", "plum", "quince", "rambutan", "starfruit",
    "tomato", "ugli", "vanilla"];

  string[] secondWords = ["kiwi", "lemon", "mango", "nectarine", "orange", "papaya", 
    "quandong", "rhubarb", "soursop", "tamarind", "ugli", "voavanga",
    "watermelon", "xigua", "yuzu", "zucchini", "apricot", "blackberry",
    "coconut", "durian", "elderberry"];

  string[] thirdWords = ["quince", "raspberry", "strawberry", "tangerine", "ugli", "voavanga", 
    "watermelon", "xigua", "yamamomo", "zucchini", "apple", "banana",
    "cantaloupe", "dragonfruit", "elderberry", "fig", "grapefruit", "huckleberry",
    "ilama", "jujube", "kiwano"];
